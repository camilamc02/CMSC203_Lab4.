   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   for(int rIndex=0;rIndex<intArray.length;rIndex++)
	   {
		   	for(int cIndex=0;cIndex<intArray[rIndex].length;cIndex++)
		   	{
				   System.out.print(intArray[rIndex][cIndex] + " ");
				   animate(rIndex,cIndex);
		   	}
	   }
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   ...
	   for(int colI=0;colI<intArray[row].length;colI++)
	   {
		   intArray[row][colI]=value;
		   animate( row, colI );
	   }
   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   {
		   if(intArray[index][column]<min)
			   min=intArray[index][column];
		   animate(index,column,min);
	   }
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	  ...
	  for(int rowInd=0;rowInd<intArray.length;rowInd++)
	  {
		  for(int colInd=0;colInd<intArray[rowInd].length;colInd++)
		  {
			  if(intArray[rowInd][colInd]==value)
			  {
				  count++;
			  }	
			  animate( rowInd, colInd, value );
		  }
